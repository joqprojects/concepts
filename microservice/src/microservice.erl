...
upgrade(Module)-> gen_server:call(?MODULE, {upgrade,Module},infinity).
upgrade()-> gen_server:cast(?MODULE, {upgrade}).
...
%% Returns: non
%% --------------------------------------------------------------------
handle_call({upgrade,Module}, From, State) ->
    Reply=case code:purge(Module) of
	      false->
